...
public class NewCameraController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        desiredPositionObject = new GameObject("Camera Target");
    ...
    void Update()
    {
        ...
        //     transform.position = desiredPositionObject.transform.position = desiredPositionObject.transform.position + new Vector3(0, 0.2f, 0);
